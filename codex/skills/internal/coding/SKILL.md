---
name: coding
description: 既存コードベースで機能追加、修正、バグ修正、テスト追加を実装するときに守る判断原則と進め方を定義するスキル。仕様や公開契約を壊さず、既存の構造・命名・責務境界に合わせ、可読性・保守性・テスト容易性を保った差分を作るときに使う。レビューのみは code-review、リファクタリング方針のみは code-refactor を優先する。
---
